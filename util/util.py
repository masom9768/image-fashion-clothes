...
import coco
#from util.cclothes import utils
...
def labelcolormap(N):
    if N == 19:  # clothes
        cmap = np.array([255, 0, 0], [255, 85, 0], [255, 170, 0], [255, 255, 0], [170, 255, 0], [85, 255, 0], [0, 255, 0],
...
class Colorize(object):
    ...
    def __call__(self, gray_image):
        ...
        return color_image
#folder_base = '/users/farhad/dfc/clothes/Clothes-mask'
#folder_save = '/users/farhad/dfc/clothes/Clothes-mask-vis'
#img_num = 30000
