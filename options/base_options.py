...
import torch
from  models import mmodels
from data import mdata
#import models.mmodels
#import data.mdata
import pickle
import os
...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids:e.g. 0  0. use -1 for CPU')
        ...
        # for setting inputs
        parser.add_argument('--dataroot', type=str, default='./datasets/CelebA-HQ/')
        parser.add_argument('--dataset_mode', type=str, default='pix2pix')
    ...
    def gather_options(self):
        ...
        model_option_setter = mmodels.get_option_setter(model_name)
        parser = model_option_setter(parser, self.isTrain)

        # modify dataset-related parser options
        dataset_mode = opt.dataset_mode
        dataset_option_setter = mdata.get_option_setter(dataset_mode)
